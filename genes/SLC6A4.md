...
There are 3 well known variants in this gene: <variant list?>
...
This variant is a change at a specific point in the <gene_symbol> gene from thymine (T) to guanine (G), resulting in reduced protein creation.  This substitution of a single nucleotide is known as a mis-sense mutation.
