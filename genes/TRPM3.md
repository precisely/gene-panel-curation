...
<# A70542500G #>
  <Genotype hgvs="NC_000009.12:g.[70542500G>A];[70542500=]" name="A70542500G"> 

    # What does this mean?
 
    People with this variant have one copy of the [A70542500G](https://www.ncbi.nlm.nih.gov/projects/SNP/snp_ref.cgi?rs=10780944)

    # What is the effect of this variant?

    This variant has unknown risk.

    # How common is this genotype in the general population?

    <piechart percentage=23.9 />
  </Genotype>
  <Genotype hgvs="NC_000009.12:g.[70542500G>A];[70542500G>A]" name="A70542500G"> 
 
    # What does this mean?

    People with this variant have two copies of the [A70542500G](https://www.ncbi.nlm.nih.gov/projects/SNP/snp_ref.cgi?rs=10780944) variant. This substitution of a single nucleotide is known as a missense mutation.
  ...
  <Genotype hgvs="NC_000009.12:g.[70542500=];[70542500=]" name="A70542500G"> 
...
Calcium mobilization into white blood cells is reduced by the A70822908G (A;G) variant, which may cause increased immune system disfunction, such as improper development of antibodies, and increased symptom severity. This variant is [2.2X](https://www.ncbi.nlm.nih.gov/pubmed/27834303) as common in CFS patients as compared to the general population.

# What should I do about this?

[CFS patients show muscarinic antibody positivity and reduced symptom presentation following anti-CD20 intervention.](https://www.ncbi.nlm.nih.gov/pubmed/27834303)
...
Biological processes responsible for the varied symptoms reported for [CFS/ME](https://www.ncbi.nlm.nih.gov/pubmed/27835969) may involve ion channels and receptors that are located on cells throughout the body. The channels maintain homeostasis, and incorrect function has been linked to [chronic pain, overactive bladder, diabetes, chronic obstructive pulmonary disease, cardiac hypertrophy, familial Alzheimer’s disease, skin diseases, neuropathy, and cancer](https://www.ncbi.nlm.nih.gov/pubmed/27835969). In CFS patients, TRP channels are targeted during inflammatory reactions, and may play a role in [multiple chemical sensitivity (MCS)](http://journals.sagepub.com/doi/pdf/10.4137/III.S25147).
...
Patients may improve after removal of cataracts and should be monitored carefully to prevent further lens and iris adhesion due to [incorrect surgery](https://www.ncbi.nlm.nih.gov/pubmed/19246951).
